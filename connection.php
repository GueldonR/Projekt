...
curl_setopt($ch, CURLOPT_POSTFIELDS, '{"usr":"a23eribe+testapi@student.his.se", "pwd":"Grupp4API"}');
...
$ch = curl_init($baseurl . 'api/resource/Patient/Roland%20(G4)%20Kaffe');
...
curl_setopt($ch, CURLOPT_IPRESOLVE, CURL_IPRESOLVE_V4);
curl_setopt($ch, CURLOPT_COOKIEJAR, $cookiepath);
curl_setopt($ch, CURLOPT_COOKIEFILE, value: $cookiepath);
curl_setopt($ch, CURLOPT_TIMEOUT, $tmeout);
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
